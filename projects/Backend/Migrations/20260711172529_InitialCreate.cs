    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VolumeSets", x => x.Id);
                })
                .Annotation("MySQL:Charset", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ObtainedDate = table.Column<DateOnly>(type: "date", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReadLogs", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookId = table.Column<int>(type: "int", nullable: false),
                    ShelvedDate = table.Column<DateOnly>(type: "date", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime(6)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Shelvings_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Shelvings_Bookshelves_BookshelfId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shelvings_BookId",
                table: "Shelvings",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_Shelvings_BookshelfId",
                table: "Shelvings",
                column: "BookshelfId");

            migrationBuilder.CreateIndex(
                name: "IX_Volumes_SetId",
                table: "Volumes",
                column: "SetId");
        }
